...
void Triangle::implicitize()
{
	...
	/*Vec2 p0_t = scene_xf.apply( model_xf.apply( p0.homogeneous() ) ).euclidean();
	Vec2 p1_t = scene_xf.apply( model_xf.apply( p1.homogeneous() ) ).euclidean();
	Vec2 p2_t = scene_xf.apply( model_xf.apply( p2.homogeneous() ) ).euclidean();*/
